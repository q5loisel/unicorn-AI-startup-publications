...
TARGET_DATABASES = {
    "PPRN":   "Preprint Citation Index (arXiv, etc.)",
}
...
def main():
    ...
    for affil in AFFILIATIONS:
        ...
        for db_id in TARGET_DATABASES.keys():
            ...
            for record in records:
                ...
                # IF WE ALREADY HAVE THIS PAPER: just add the matched startup and skip re-extraction.
                ...
                # Finally, save all this extracted data to our master dictionary!
                unique_records[dedup_key] = {
                    "original_uid": uid,
                    "source_db_list": [db_id],
    ...
    # ---------------------------------------------------------
    csv_filename = os.path.join(DATA_DIR, "preprints_papers.csv")
